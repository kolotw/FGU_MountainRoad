	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord32 = IN.ase_texcoord8.zw * float2( 1,1 ) + float2( 0,0 );
				float4 lerpResult16 = lerp( ( tex2DNode1 * _Color ) , ( tex2D( _Albedo, texCoord32 ) * _Color0 ) , IN.ase_color.a);
				
				float2 texCoord40 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack5 = UnpackNormalScale( tex2D( _BumpMap, texCoord40 ), _BumpScale );
				unpack5.z = lerp( 1, unpack5.z, saturate(_BumpScale) );
				float3 unpack23 = UnpackNormalScale( tex2D( _DetailNormalMapScale, texCoord32 ), _BumpScale1 );
				unpack23.z = lerp( 1, unpack23.z, saturate(_BumpScale1) );
				float3 lerpResult24 = lerp( unpack5 , unpack23 , IN.ase_color.a);
				
				float2 uv_Metallic = IN.ase_texcoord8.xy * _Metallic_ST.xy + _Metallic_ST.zw;
				float4 tex2DNode2 = tex2D( _Metallic, uv_Metallic );
				float4 tex2DNode25 = tex2D( _MetallicGlossMap2, texCoord32 );
				float lerpResult26 = lerp( ( tex2DNode2.r * _MetallicPower ) , ( tex2DNode25.r * _Float0 ) , IN.ase_color.a);
				
				float lerpResult27 = lerp( ( tex2DNode2.a * _SmoothnessPower ) , ( tex2DNode25.a * _Float1 ) , IN.ase_color.a);
				
				float lerpResult29 = lerp( ( tex2DNode2.g * _OcclusionStrength ) , ( tex2DNode25.g * _AmbientOcclusionPower ) , IN.ase_color.a);
